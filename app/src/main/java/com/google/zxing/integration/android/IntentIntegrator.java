 ...
 *
 * <p>There are a few steps to using this integration. First, your {@link FragmentActivity} must implement
 * the method {@link FragmentActivity#onActivityResult(int, int, Intent)} and include a line of code like this:</p>
 *
 * <pre>{@code
...
public class IntentIntegrator {
     ...
     */
    public IntentIntegrator(@org.jetbrains.annotations.NotNull Fragment fragment) {
