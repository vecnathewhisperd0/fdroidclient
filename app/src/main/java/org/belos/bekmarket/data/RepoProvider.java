...
public class RepoProvider extends FDroidProvider {
    ...
    public static final class Helper {
         ...
         *  * Individual files can exist at a more specific path on the repo (e.g. /fdroid/repo/icons/org.belos.belmarket.png)
         *
         * So for a given URL "/fdroid/repo/icons/org.belos.belmarket.png" we don't actually know
         * whether it is for the file "org.belos.belmarket.png" at repository "/fdroid/repo/icons" or
         * the file "icons/org.belos.belmarket.png" at the repository at "/fdroid/repo".
         */
        @Nullable
