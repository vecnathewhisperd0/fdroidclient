...
public class InstallerService extends IntentService {
    ...
    private static final String ACTION_INSTALL = "org.belos.belmarket.installer.InstallerService.action.INSTALL";
    private static final String ACTION_UNINSTALL = "org.belos.belmarket.installer.InstallerService.action.UNINSTALL";
