...
public class AppProviderTest extends FDroidProviderTest {
    ...
    public void testInsert() {
        ...
        // Insert a new record...
        insertApp("org.belos.belmarket", "F-Droid");
        cursor = queryAllApps();
        assertNotNull(cursor);
        ...
        cursor.close();
        assertEquals("org.belos.belmarket", app.packageName);
        assertEquals("F-Droid", app.name);

        App otherApp = AppProvider.Helper.findSpecificApp(context.getContentResolver(), "org.belos.belmarket", 1, Cols.ALL);
        assertNotNull(otherApp);
        assertEquals("org.belos.belmarket", otherApp.packageName);
