...
public class TestUtils {
    ...
    public static final String FDROID_SIGNER;
    public static final String UPSTREAM_SIGNER;
    public static final String THIRD_PARTY_SIGNER;
    ...
    private static String formatSigForDebugging(String sig) {
        ...
        if (sig.equals(FDROID_SIGNER)) {
            suffix = "F-Droid";
        } else if (sig.equals(UPSTREAM_SIGNER)) {
            suffix = "Upstream";
        } else if (sig.equals(THIRD_PARTY_SIGNER)) {
            suffix = "3rd Party";
        } else {
            suffix = "Unknown";
        }
    ...
    public static Apk insertApk(Context context, App app, int versionCode, String signature) {
        ...
        values.put(Schema.ApkTable.Cols.SIGNER, signature);
